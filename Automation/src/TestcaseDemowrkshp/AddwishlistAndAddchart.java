...
public class AddwishlistAndAddchart {
	static {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='giftcard_4_RecipientName']")).sendKeys("manu");
		driver.findElement(By.xpath("//input[@id='giftcard_4_SenderName']")).sendKeys("shiva");
